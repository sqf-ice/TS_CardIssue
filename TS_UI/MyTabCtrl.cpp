...
void CMyTabCtrl::ChangeTab(int iIndex, CWnd *pNewTab, LPTSTR lpszCaption, int iImage)
{
...
BOOL CMyTabCtrl::SelectTabByName(LPCTSTR lpszTabCaption)
{
	TCHAR szName[64];
	TCITEM item;
...
BOOL CMyTabCtrl::SelectNextTab(BOOL bForward)
{
